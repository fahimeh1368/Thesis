...
{
    public class WhoDoWithCommitWorkShareStrategy : ScoreBasedRecommendationStrategy
    {
        ...
        public WhoDoWithCommitWorkShareStrategy(string knowledgeSaveReviewerReplacementType,
